...
Choose an option:  "
    ...
    1)     
            ...
            sudo openssl req -new -x509 -newkey rsa:2048 -keyout /var/lib/shim-signed/mok/Nvidia.key -outform DER -out /var/lib/shim-signed/mok/Nvidia.der -nodes -days 36500 -subj "/CN=Graphics Drivers"
